...
const HomeTop = () => {
  return (
    <>
      <div className="position-relative text-white w-auto border-0">
        <img src={TopShopImg} alt="shop" className="img-fluid" />

        <div className="container h-75">
          <div className="card-img-overlay d-flex ">
            <div className="my-auto shippori ps-3 py-3 top-grad">
              <h4 className="card-title pb-2">Cafe Chilla&apos;s</h4>
              <p className="card-text ">
                「Cafe Chilla&apos;s」は都会の喧騒を忘れて
                <br />
                癒しとくつろぎを求めるあなたのための特別な場所です
                <br />
                心地よいBGMと暖かい雰囲気の中で
                <br />
          ...
          <div className="card-img-overlay d-flex h-100">
